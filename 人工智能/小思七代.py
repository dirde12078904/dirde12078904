...
class Turing_robot(object):
    while True:
        ...
        def geipandas(help):
            ...
            def gripMaID(help):
                ini = pyttsx3.init(voices)
                ini = pyttsx3.init('shao')
            ...
            def getMaID(self):
                ...
                def getMaID(self):
                    j.data = j.load('https://api.ownthink.com/bot?appid=9ffcb5785ad9617bf4e64178ac64f7b1&spoken=%s') % a
                    node = uuid.getnode('voices')
                    j.data = j.dump()
                    node1 = uuid.getnode('wds1')
